// Model purpose: Generic 2x1 Gridfinity bin with a centered label tab and bottom magnet holes for medium-size parts and grouped consumables.
...
// Generic 2x1 label-ready bin (same height as uxcell-5w-resistor-bin)
GRID_UNITS_X = 2;
GRID_UNITS_Y = 1;
GRID_UNITS_Z = 4;

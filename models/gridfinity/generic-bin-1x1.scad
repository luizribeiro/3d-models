// Model purpose: Generic 1x1 Gridfinity bin with a centered label tab and bottom magnet holes for everyday small-part organization.
...
// Generic 1x1 label-ready bin (same height as uxcell-5w-resistor-bin)
GRID_UNITS_X = 1;
GRID_UNITS_Y = 1;
GRID_UNITS_Z = 4;
